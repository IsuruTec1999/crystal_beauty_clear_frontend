        ...
        <div className="w-full h-full">
            ...
            }
            {
                ...
                <div className="w-full h-full flex flex-col lg:flex-row ">
                    <h1 className="lg:hidden text-black  text-center  text-3xl font-bold mb-[40px]">{product.name}{" | "}<span className="text-gray-500   text-3xl mr-[20px]"> {product.altName.join(" | ")}</span></h1>
                    ...
                    <div className="w-full lg:w-[50%] pt-[100px]  h-full  p-[40px]">
                        <h1 className=" hidden lg:block text-black  text-center  text-3xl font-bold mb-[40px]">{product.name}{" | "}<span className="text-gray-500   text-3xl mr-[20px]"> {product.altName.join(" | ")}</span></h1>
